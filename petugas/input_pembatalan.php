...
if (isset($_POST['submit'])){
	...
	if (!$result->num_rows>0) {
        ...
        // $sql = "INSERT INTO data_baru (nop_baru, nama_wp_baru, alamat_baru, desa_wp_baru, rt_wp_baru, rw_wp_baru, kabupaten_baru, letak_op_baru, desa_op_baru, rt_op_baru, rw_op_baru, kecamatan_baru, bumi_baru, bangunan_baru)
        ...
        $sql = "INSERT INTO pelayanan (no_pelayanan, jenis_pelayanan, id_data_lama, id_data_baru, perubah) values ('$no_pelayanan', '$jenis_pelayanan','$id_lama', '$id_data_baru', '$perubah') ";
		$result = mysqli_query($koneksi, $sql);
...
<br>
	...
	<br>
    <div class="border border-start-9 shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="width: 500px; margin:auto; ">
        <form action="" method="POST" class="row">
            <div class="mb-3">
            <label class="form-label">Jenis Pelayanan : Pembatalan</label><br>
            ...
            <div class="border border-start shadow-lg p-3  bg-body-tertiary rounded card-body" style="width:300px; margin:auto;">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"placeholder="" name="nop_lama" value="<?php echo $nop_lama;  ?>" required>
                </div>
                <h5 class="form-label">Wajib Pajak</h5>
                <div class="row g-3">
                    <div class="col">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-control" placeholder="" name="nama_wp_lama" value="<?php echo $nama_wp_lama;  ?>" required>
                    </div>    
                    <div class="col">
                        <label class="form-label">Alamat</label>
                        <input type="text" class="form-control" placeholder="" name="alamat_lama" value="<?php echo $alamat_lama;  ?>" required>
                    </div>    
                </div>
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label">Desa</label>
                        <input type="text" class="form-control" placeholder="" name="desa_wp_lama" value="<?php echo $desa_wp_lama;  ?>" required>
                    </div>    
                    <div class="col-md-2">
                        <label class="form-label">RT</label>
                        <input type="text" class="form-control" placeholder="" name="rt_wp_lama" value="<?php echo $rt_wp_lama;  ?>" required>
                    </div>    
                    <div class="col-md-2">
                        <label class="form-label">RW</label>
                        <input type="text" class="form-control" placeholder="" name="rw_wp_lama" value="<?php echo $rw_wp_lama;  ?>" required>
                    </div>    
                    <div class="col-md-4 mb-3">        
                        <label class="form-label">Kabupaten</label>
                        <input type="text" class="form-control" placeholder="" name="kabupaten_lama" value="<?php echo $kabupaten_lama;  ?>" required>
                    </div>    
                </div>  
                ...
                <div class="row g-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" placeholder="" name="letak_op_lama" value="<?php echo $letak_op_lama;  ?>" required>
                    </div>    
                    <div class="col">
                        <label class="form-label">Desa Objek Pajak</label>
                        <input type="text" class="form-control" placeholder="" name="desa_op_lama" value="<?php echo $desa_op_lama;  ?>" required>
                    </div>    
                </div>
                <div class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label">RT</label>
                        <input type="text" class="form-control" placeholder="" name="rt_op_lama" value="<?php echo $rt_op_lama;  ?>" required>
                    </div>    
                    <div class="col-md-3">
                        <label class="form-label">RW</label>
                        <input type="text" class="form-control" placeholder="" name="rw_op_lama" value="<?php echo $rw_op_lama;  ?>" required>
                    </div>    
                    <div class="col-md-6">
                        <label class="form-label">Kecamatan</label>
                        <input type="text" class="form-control" placeholder="" name="kecamatan_lama" value="<?php echo $kecamatan_lama;  ?>" required>
                    </div>    
                </div>
                <div class="row g-3">
                    <div class="col">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="" name="bumi_lama" value="<?php echo $bumi_lama;  ?>" required>
                    ...
                    <div class="col">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="" name="bangunan_lama" value="<?php echo $bangunan_lama;  ?>" required>
                            <div class="input-group-text">m<sup>2</sup></div>
                        </div>
                    </div> 
                </div>
            ...
            <div class="mb-3">
                    <input hidden type="text" class="form-control"placeholder="jenis_pelayanan" name="jenis_pelayanan" value="Pembatalan" required>
                </div>
