...
if (isset($_POST['submit'])){
	...
	if (!$result->num_rows>0) {
        ...
        $sql = "INSERT INTO pelayanan (no_pelayanan, jenis_pelayanan, id_data_lama, id_data_baru, perubah) values ('$no_pelayanan', '$jenis_pelayanan','$id_lama', '$id_baru','$perubah') ";
		$result = mysqli_query($koneksi, $sql);
...
<br>
    ...
    <div class="border border-start-9 shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="width: 1000px; margin:auto; ">
        <form action="" method="POST" class="row">
            <div class="mb-3">
            <label class="form-label">Jenis Pelayanan : Pembetulan</label><br>
            ...
            <div class="mb-3">
                    <input hidden type="text" class="form-control"placeholder="jenis_pelayanan" name="jenis_pelayanan" value="Pembetulan" required>
                </div>
