...
if (isset($_POST['submit'])){
  ...
  $sql = "SELECT * from hasil_verifikasi where no_pelayanan='$no_pelayanan'";
	...
	if (!$result->num_rows>0) {
        ...
        $sql = "INSERT INTO hasil_verifikasi (id_verifikasi, no_pelayanan, no_surat, status, hasil, id_user) values ('', '$no_pelayanan', '$no_surat', '$status', '$hasil', '$id_user') ";
		$result = mysqli_query($koneksi, $sql);
    ...
    <div class="m-5" style="width: auto; ">
        <form action="" method="POST" class="login-email row border border-start-0 shadow-lg p-3 rounded">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"placeholder="No surat" name="no_surat" value="<?php echo $no_surat  ?>" required>
            </div>
            ...
            <!-- <div class="mb-3">
                ...
                <input type="text" class="form-control"placeholder="Hasil Verifikasi" name="hasil" value="<?php echo $hasil  ?>" required>
            </div> -->
            <div class="form-floating">
              <textarea class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px" name="hasil" required><?php echo $hasil  ?></textarea>
              <label for="floatingTextarea2">Hasil Verifikasi</label>
            </div>
