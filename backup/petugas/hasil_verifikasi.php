...
<br>
	<div class="judul">
		<h1 align="center">Hasil Verifikasi</h1>
	</div>
	<br>
...
?>
    ...
    <div style=" ">
		...
		<a href="tambah_verifikasi.php" class="tombol"><button class="btn btn-primary" style="padding:0px 5px; margin: 5px;">+ Tambah Data Baru <--</button></a>
