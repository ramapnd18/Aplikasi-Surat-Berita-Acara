...
while ($data = mysqli_fetch_assoc($result)) {
    ...
    <table style="margin:auto;" cellspacing="0" border="0" >
        ...
        <tr >
            <td colspan="13 " style="border-bottom: 4px solid black;padding: 6px; font-weight: bold; font-family: Calibri; font-size: 150%;" align="center">BADAN PEMDAPATAN DAERAH</td>
        </tr>
        <tr>
            <td colspan="2"></td>
        ...
        <tr>
            ...
            <td></td>
            <td>:</td>
            <td colspan="4" class="input"><input type="text" value="<?php echo $data['no_surat']?>" disabled></td>
            <td></td>
...
-<?php echo $data['hasil']?></textarea></td>
        ...
        <tr>
            <td colspan="7"></td>
            <td colspan="4">Kepala Desa desa</td>
        </tr>
        <tr>
            <td><br></td>
        </tr>
