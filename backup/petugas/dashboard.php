      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="input_mutasi.php">Mutasi Pembetulan</a></li>
          </ul>
        </div>
        <li class="nav-item">
...
<br>
<h2 align="center">Selamat Datang Di SI Pengelola Data Verifikasi Objek PBB-P2 BERBASIS WEB BAPENDA Pangandaran</h2>
<br>
<div style="margin:auto; width: 326px;"><img src="../img/logo_bapenda.png" style="width:326px;"></div>
