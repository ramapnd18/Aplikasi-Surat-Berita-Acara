...
<br>
	<div class="judul">
		<h1 align="center">Ubah Hasil Verifikasi</h1>
	</div>
...
while ($data = mysqli_fetch_assoc($result)) {
	?>
	<div class="ma" style="width: 300px; margin:auto;">
        <form action="update_verifikasi.php" method="POST" class="login-email row border border-start-0 shadow-lg p-3 rounded">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="NO Surat" name="no_surat" value="<?php echo $data['no_surat']?>" >
                </div>    
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Hasil Verifikasi" name="hasil" value="<?php echo $data['hasil']?>" >
                </div>    
                <div class="mb-3">
