...
error_reporting();
    ...
    $query = "UPDATE pelayanan SET no_pelayanan='$no_pelayanan', jenis_pelayanan='$jenis_pelayanan', id_data_lama='$id_data_lama', id_data_baru='$id_data_baru' where no_pelayanan='$no_pelayanan'";
