...
if (isset($_POST['submit'])){
	...
	if (!$result->num_rows>0) {
        ...
        $sql = "INSERT INTO pelayanan (no_pelayanan, jenis_pelayanan, id_data_lama, id_data_baru) values ('$no_pelayanan', '$jenis_pelayanan','$id_data_lama', '$id_baru') ";
		$result = mysqli_query($koneksi, $sql);
