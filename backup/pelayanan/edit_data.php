...
<br>
	<div class="judul">
		<h1 align="center">Ubah Data Verifikasi</h1>
	</div>
...
while ($data = mysqli_fetch_assoc($result)) {
	...
	<div class="m-5" style="width: auto; ">
        <form action="update_data.php" method="POST" class="login-email row border border-start-0 shadow-lg p-3 rounded">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"placeholder="Jenis pelayanan" name="jenis_pelayanan" value="<?php echo $data['jenis_pelayanan']?>" >
            </div>
            <div class="border border-start-0 shadow-lg p-3  bg-body-tertiary  rounded card-body" style="width:300px; margin:auto;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Letak OP" name="letak_op_lama" value="<?php echo $data['letak_op_lama']?>" >
                </div>    
                <div class="mb-3">
                    <label class="form-label">Desa OP</label>
                    <input type="text" class="form-control" placeholder="Desa OP" name="desa_op_lama" value="<?php echo $data['desa_op_lama']?>" >
                </div>    
                <div class="mb-3">
                    <label class="form-label">RT</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Kecamtan Op" name="kecamatan_lama" value="<?php echo $data['kecamatan_lama']?>" >
                </div>    
                <div class="mb-3">
            ...
            <div class="border border-start shadow-lg p-3  bg-body-tertiary rounded card-body" style="width:300px; margin:auto;">
                ...
                <div class="mb-3">
                    <label class="form-label">Letak OP</label>
                    <input type="text" class="form-control" placeholder="Letak OP" name="letak_op_baru" value="<?php echo $data['letak_op_baru']?>" >
                </div>    
                <div class="mb-3">
                    <label class="form-label">Desa OP</label>
                    <input type="text" class="form-control" placeholder="Desa OP" name="desa_op_baru" value="<?php echo $data['desa_op_baru']?>" >
                </div>    
                <div class="mb-3">
                    <label class="form-label">RT</label>
                ...
                <div class="mb-3">
                    <label class="form-label">Kecamatan OP</label>
                    <input type="text" class="form-control" placeholder="Kecamtan OP" name="kecamatan_baru" value="<?php echo $data['kecamatan_baru']?>" >
                </div>    
                <div class="mb-3">
                    <label class="form-label">Bumi</label>
